  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="px-4 pt-4 pb-3 flex items-center gap-3">
        ...
        <div>
          <h2 className="font-display text-xl font-bold text-foreground">Register My Shop</h2>
          <p className="text-xs text-muted-foreground font-body">Join the Dukaan network</p>
        </div>
      </div>
      ...
      <div className="mx-4 mb-4 gradient-maroon rounded-2xl p-4 flex items-center gap-3 shadow-sm">
        ...
        <div>
          <p className="font-display font-bold text-ivory text-sm">Connect with 1000s of Shopkeepers</p>
          <p className="text-xs text-ivory/80 font-body">Register your shop and grow your network</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="px-4 space-y-4 pb-6">
        ...
        <div className="space-y-1.5">
          <Label className="font-body font-semibold text-sm">Owner Name *</Label>
          <Input
            value={form.name}
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="rounded-xl font-body"
          />
          {errors.shopName && <p className="text-xs text-destructive font-body">{errors.shopName}</p>}
        </div>

        {/* Location - City Search */}
        <div className="space-y-1.5">
          <Label className="font-body font-semibold text-sm">City / Location *</Label>
          <CitySearchInput
            value={form.location}
        ...
        {/* Category */}
        <div className="space-y-1.5">
          <Label className="font-body font-semibold text-sm">Business Category *</Label>
          <Input
            value={form.category}
            onChange={handleChange('category')}
            placeholder="e.g. Groceries, Electronics, Clothing, Hardware"
            className="rounded-xl font-body"
          />
