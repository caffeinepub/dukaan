...
import { useShortlistedProducts, useToggleShortlist } from '../hooks/useQueries';
    ...
    <div className="animate-fade-in">
      ...
      <div className="px-4 pt-5 pb-3">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="font-display text-xl font-bold text-foreground">My Shortlist</h2>
      ...
      <div className="px-4 pb-4">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h3 className="font-display font-bold text-foreground mb-1">No Shortlisted Products</h3>
