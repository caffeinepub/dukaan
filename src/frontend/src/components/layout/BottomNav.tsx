          ...
          return (
            <Link
              ...
              className={`flex-1 flex flex-col items-center justify-center py-2 gap-0.5 transition-all duration-150 ${
                isActive ? "text-saffron" : "text-ivory/60 hover:text-ivory/90"
              }`}
            >
              <div
                className={`relative p-1 rounded-lg transition-all ${isActive ? "bg-saffron/20" : ""}`}
              >
              ...
              <span
                className={`text-[10px] font-body font-semibold tracking-wide ${isActive ? "text-saffron" : ""}`}
              >
                {label}
              </span>
            </Link>
