      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-maroon/70 to-transparent flex items-center px-5">
          <div>
            ...
            <p className="text-sm text-ivory/80 font-body">
              Welcome to your Dukaan
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-5">
        ...
        {isLoading ? (
          <div className="grid grid-cols-2 gap-3">
            {["a", "b", "c", "d", "e", "f"].map((k) => (
              <MetricSkeleton key={`skeleton-metric-${k}`} />
            ))}
          </div>
        ) : metrics ? (
          <div className="grid grid-cols-2 gap-3">
            ...
            {[
              {
                ...
                icon: Package,
                to: "/products/new",
                color: "bg-saffron text-ivory",
              },
              {
                label: "View Stock",
                icon: BarChart3,
                to: "/stock",
                color: "bg-maroon text-ivory",
              },
              {
                label: "Network",
                icon: Users,
                to: "/network",
                color: "bg-maroon-light text-ivory",
              },
